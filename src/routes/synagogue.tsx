      ...
      <div className="mx-6 rounded-3xl overflow-hidden border border-border shadow-soft">
        <div className="h-36 navy-gradient relative">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 30%, oklch(0.82 0.14 80) 0, transparent 40%), radial-gradient(circle at 80% 60%, oklch(0.78 0.07 240) 0, transparent 40%)",
            }}
          />
          <div className="absolute bottom-3 left-4 flex items-center gap-2">
            <StatusPill tone="gold">
              <ShieldCheck className="h-3 w-3 mr-1" />
              {t("synagogue.verified")}
            </StatusPill>
            ...
            <div key={i} className="p-4 flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-muted-foreground">
                  {r.s === "confirmed"
                    ? t("synagogue.confirmedReady", { count: r.c })
                    : r.s === "almost"
                      ? t("synagogue.missing", { count: r.c })
                      : t("synagogue.rsvp")}
                </div>
              </div>
              <StatusPill
                tone={r.s === "confirmed" ? "success" : r.s === "almost" ? "gold" : "sky"}
              >
                {r.s === "confirmed"
                  ? t("synagogue.confirmed")
                  : r.s === "almost"
                    ? t("synagogue.almost")
                    : t("synagogue.open")}
              </StatusPill>
