  ...
  return (
    <MobileFrame bg="navy" showNav={false}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center text-white">
        ...
        <h1 className="font-display text-3xl mt-8 leading-tight max-w-xs">
          Request a minyan for Kaddish
        </h1>
        <p className="text-sm text-white/70 mt-3 max-w-xs leading-relaxed">
          Your community will quietly mobilize. Nearby Jews will be gently asked to help complete a minyan in your honor.
        </p>
        ...
        <div className="mt-8 w-full max-w-sm space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="When" value="Mincha · today" />
            <Field label="Where" value="Here · 0.5 mi" />
          </div>
          <div className="rounded-2xl bg-white/5 border border-white/10 p-4 text-left">
            <label className="text-[10px] uppercase tracking-wider text-white/50">Personal note (optional)</label>
            <input
              className="w-full bg-transparent outline-none text-sm mt-1 placeholder:text-white/40"
              placeholder="Shloshim · with deepest gratitude"
            />
          </div>
        </div>

        <LiveBadge>QUIET URGENT</LiveBadge>
      </div>
